"""Analysis module for price/listing summaries and signal classification."""
...
class PriceAnalysisAgent:
    """Compute summary metrics and simple signals from price history."""
